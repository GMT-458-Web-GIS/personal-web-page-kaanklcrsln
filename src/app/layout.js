...
export default async function RootLayout({ children }) {
  const isEnabled = false // Static export - no draft mode

  return (
    <html lang="en" className={`${GeistSans.variable} ${GeistMono.variable}`} suppressHydrationWarning>
      <head>
        <link rel="icon" href="/assets/ioslogo.png" type="image/png" />
      </head>
...
export const metadata = {
  metadataBase: new URL('https://kaanklcrsln.github.io'),
  robots: {
    index: true,
    follow: true
  },
  ...
  keywords: ['Kaan Kılıçarslan', 'kaanklcrsln.github.io', 'Geomatics Engineer', 'Remote Sensing'],
  openGraph: {
    title: {
      default: sharedMetadata.title,
      template: `%s — ${sharedMetadata.title}`
    ...
    type: 'website',
    url: 'https://kaanklcrsln.github.io',
